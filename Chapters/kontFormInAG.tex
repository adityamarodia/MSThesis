...
\begin{proof}[Sketch of proof]
    ...
    \[
        ...
        \end{tikzcd}.
    \]
    Here, $\pho$ is a $k$-fold cover of $\mathbb{P}^{1}$, and $\psi$ is a degree $e$ map birational to its image. We know that this factorisation is not unique (since $\text{Aut}(\mathbb{P}^{1})$ is non trivial).
