...
\section{Stable Maps}
\textcolor{red}{[Rewrite this paragraph later]}This section assumes some primitive familiarity with Intersection Theory. \textcolor{red}{[Should I add things in appendix about this later?]}.
...
dotted arrow latex
\par \textcolor{red}{Add disscussion about k-fold covers. And exlpain what we will do with the next two lemmas.}
...
\begin{definition}
    \textcolor{red}{Give definiton of \textbf{the} moduli space of maps, and do a dimension count}
\end{definition}
...
Hint at the remark  from previous section.
\begin{definition}
...
\begin{theorem}
    $\overline{\mathcal{M}}_{0,n}(\mathbb{P}^{r},d)$ is a projective normal irreducible variety, and it is locally ismorphic to a quitient of a smooth varity by the action of a finite group.
    It contains $\overline{\mathcal{M}}^{*}_{0,n}(\mathbb{P}^{r},d)$ as aa smooth oprn dense subvariety which is a fine moduli space for maps without automorphisms.
\end{theorem}

\par \textcolor{red}{Do a dimension count of the moduli space}.
...
\subsubsection{Consequence of Flatness of Evaluation Maps and Examples}
\subsubsection{Evaluation Maps and Their Properties}

\subsection{Boudary Divisors and Their Properties}
