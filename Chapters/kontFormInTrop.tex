...
They are the tropical counterparts of "labeled configurations" \textcolor{red}{[cite defn]} for raional plane curves.
...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item if $C$ is of type $2.$ from lemma \ref{reduCntLem} then:
            ...
            \]
    \end{enumerate}
    where $R_{1}=R_{2}$ corresponds to the point of intersection of the curves $C_{1}$ and $C_{2}$ obtained by splitting $C$ along the contracted bounded edge, and $(C_{1}\dot L_{i})$
\end{proposition}
