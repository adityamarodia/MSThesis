...
Since abstract tropical curves are topological spaces it's easy to define isomorphisms between them.
...
\begin{example}[Looking at $M_{4}$]
    ...
    \begin{figure}[h]
        ...
        \begin{subfigure}[b]{0.22\textwidth}
            \begin{tikzpicture}
                \node[inner sep = 0pt] at (0,0) {\includegraphics{Chapters/Images/nontrivM4.pdf}};
                \node at (1.2,0.7) {$x_{3}$};
                \node at (1.2,-0.7) {$x_{4}$};
                \node at (-1.2,0.7) {$x_{1}$};
                \node at (-1.2,-0.7) {$x_{2}$};
        ...
        \begin{subfigure}[b]{0.22\textwidth}
            \begin{tikzpicture}
                \node[inner sep = 0pt] at (0,0) {\includegraphics{Chapters/Images/trivM4.pdf}};
                \node at (1.2,0.7) {$x_{2}$};
                \node at (1.2,-0.7) {$x_{3}$};
                \node at (-1.2,0.7) {$x_{1}$};
                \node at (-1.2,-0.7) {$x_{4}$};
...
\begin{definition}[Forgetting the map and some points]
    ...
    And at vertices of valence $2$, we ``straighten" the graph - that is, replace the two neighbouring edges of lengths $l_{1},\,l_{2}$ with one edge of length $l_{1} + l_{2}$.
...
\begin{proof}[Sketch of proof]
    ...
    \begin{figure}[h]
        ...
        \begin{tikzpicture}
            %figure 1
            \node[inner sep = 0pt] at (0,0) {\includegraphics{Chapters/Images/degpropimg1.pdf}}; 
            ...
            %figure 2
            \node[inner sep = 0pt] at (4,0) {\includegraphics{Chapters/Images/degpropimg2}}; 
            ...
            %figure 3
            \node[inner sep = 0pt] at (7.5,0) {\includegraphics{Chapters/Images/degpropimg3}};
            ...
            %figure 4
            \node[inner sep = 0pt] at (10.5,0) {\includegraphics{Chapters/Images/degpropimg4}};
