...
\begin{proof}[Sketch of proof]
    ...
    Here we only look at the case all $4$ of the edges are preserved under the forgetful map and leave the reader to refer to \textcolor{red}{[Gathmann Markwig CITE]} for the other cases.
...
\begin{remark}
    ...
    \par It indeed does! Check \textcolor{red}{[Gathmann-Markwig]} for the details.
\end{remark}
